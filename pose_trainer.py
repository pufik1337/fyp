...
class FasterRCNNPoseTrainer(nn.Module):
    ...
    * :obj:`roi_pose_loss`: The pose loss for the head module.
    * :obj:`total_loss`: The sum of 5 losses above.
    ...
    def __init__(self, faster_rcnn):
        super(FasterRCNNPoseTrainer, self).__init__()
    ...
    def forward(self, rgb_imgs, bboxes, poses, labels, scale):
        ...
        * :math:`R` is the number of bounding boxes per image.
        ...
        features = self.faster_rcnn.extractor(rgb_imgs)
        ...
        sample_roi, gt_roi_loc, gt_roi_label, gt_roi_pose = self.proposal_target_creator(
            roi,
            at.tonumpy(bbox),
            at.tonumpy(label),
            at.tonumpy(pose),
    ...
    def train_step(self, rgb_imgs, bboxes, poses, labels, scale):
        self.optimizer.zero_grad()
        losses = self.forward(rgb_imgs, bboxes, poses, labels, scale)
